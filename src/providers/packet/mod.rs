        ...
        for a in self.data.network.addresses.clone() {
            match (a.address, a.public) {
                (IpAddr::V4(ip), true) => {
                    ...
                    attrs.push((
                        format!("PACKET_IPV4_PUBLIC_GW_{}", v4_public_counter),
                        format!("{}", a.gateway),
                    ));
                    v4_public_counter += 1;
                }
                (IpAddr::V4(ip), false) => {
                    ...
                    attrs.push((
                        format!("PACKET_IPV4_PRIVATE_GW_{}", v4_private_counter),
                        format!("{}", a.gateway),
                    ));
                ...
                (IpAddr::V6(ip), true) => {
                    ...
                    attrs.push((
                        format!("PACKET_IPV6_PUBLIC_GW_{}", v6_public_counter),
                        format!("{}", a.gateway),
                    ));
                    v6_public_counter += 1;
                }
                (IpAddr::V6(ip), false) => {
                    ...
                    attrs.push((
                        format!("PACKET_IPV6_PRIVATE_GW_{}", v6_private_counter),
                        format!("{}", a.gateway),
                    ));
